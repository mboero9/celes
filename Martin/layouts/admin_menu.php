<ul>
  ...
  <li>
    <a href="carga_movimientos.php" class="submenu-toggle">
      <i class="glyphicon glyphicon-th-large"></i>
      <span>Movimientos</span>
    </a>
    <ul class="nav submenu">
       <li><a href="vistaaccion.php">Administrar acciones</a> </li>
 ...
 <!-- <li>
  ...
  <li>
    <a href="#" class="submenu-toggle">
      ...
      <ul class="nav submenu">
        <li><a href="sales_report.php">Fechas </a></li>
        <li><a href="monthly_sales.php">POr semana</a></li>
        <li><a href="daily_sales.php">Por dia</a> </li>
      </ul>
  </li>
</ul>
